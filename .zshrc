...
__conda_setup="$('/Users/hokiX/.miniconda/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/hokiX/.miniconda/etc/profile.d/conda.sh" ]; then
        . "/Users/hokiX/.miniconda/etc/profile.d/conda.sh"
    else
        export PATH="/Users/hokiX/.miniconda/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
